    ...
    <div className="App">
      <div className="sideBar">
          ...
          <div className="lowerSide">
              <div className="listItems"><img src={home} alt="Homee" className="listItemsImg" />Home</div>
          ...
          <div className="chats">
              {messages.map((message, i) => 
                  <div key={i} className={message.isBot?"chat bot":"chat"}>
                      <img className='chatImg' src={message.isBot?gptImageLogo:userIcon} alt="" /><p className="txt">{message.text}</p>
                  </div>
              )}
              <div ref={msgEnd}/>
          </div>
